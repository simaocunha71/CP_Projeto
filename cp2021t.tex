...
É nos dado tanto o tipo da função \ensuremath{\Varid{outExpAr}} como o do seu isomorfismo \ensuremath{\Varid{inExpAr}}, assim pudendo representar o seu diagrama.
...
Seguindo o diagrama, chegamos à solução do clean. Como dissemos a solução do gene \ensuremath{\Varid{gopt}} (gene utilizado no catamorfismo do hilomorfismo), foi re-utilizara o gene do catamorfismo da questão anterior, \ensuremath{\Varid{g\char95 eval\char95 exp}}.
