...
\\
\>[17]{}\hsindent{2}{}\<[19]%
\>[19]{}\Varid{g\char95 eval\char95 binop}\;(\Varid{op},(\Varid{a1},\Varid{a2}))\mid \Varid{op}\equiv \Conid{Sum}\mathrel{=}\Varid{a1}\mathbin{+}\Varid{a2}{}\<[E]%
\\
\>[19]{}\hsindent{26}{}\<[45]%
\>[45]{}\mid \Varid{otherwise}\mathrel{=}\Varid{a1}\mathbin{*}\Varid{a2}{}\<[E]%
\\
\>[17]{}\hsindent{2}{}\<[19]%
\>[19]{}\Varid{g\char95 eval\char95 unop}\;(\Varid{op},\Varid{a1})\mid \Varid{op}\equiv \Conid{Negate}\mathrel{=}(\mathbin{-}\mathrm{1})\mathbin{*}\Varid{a1}{}\<[E]%
\\
\>[19]{}\hsindent{20}{}\<[39]%
\>[39]{}\mid \Varid{otherwise}\mathrel{=}\Varid{\Conid{Prelude}.exp}\;(\Varid{a1}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{sd\char95 binop}\;(\Varid{op},((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2})))\mid \Varid{op}\equiv \Conid{Sum}\mathrel{=}((\Conid{Bin}\;\Conid{Sum}\;\Varid{x1}\;\Varid{x2}),(\Conid{Bin}\;\Conid{Sum}\;\Varid{y1}\;\Varid{y2})){}\<[E]%
\\
\>[12]{}\hsindent{34}{}\<[46]%
\>[46]{}\mid \Varid{otherwise}\mathrel{=}((\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;\Varid{x2}),(\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;\Varid{y2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{y1}\;\Varid{x2}))){}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{sd\char95 unop}\;(\Varid{op},(\Varid{x},\Varid{y}))\mid \Varid{op}\equiv \Conid{Negate}\mathrel{=}((\Conid{Un}\;\Varid{op}\;\Varid{x}),(\Conid{Un}\;\Varid{op}\;\Varid{y})){}\<[E]%
\\
\>[12]{}\hsindent{21}{}\<[33]%
\>[33]{}\mid \Varid{otherwise}\mathrel{=}(\Conid{Un}\;\Varid{op}\;\Varid{x},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Varid{op}\;\Varid{x})\;\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{ad\char95 binop}\;(\Varid{op},((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2})))\mid \Varid{op}\equiv \Conid{Sum}\mathrel{=}(\Varid{x1}\mathbin{+}\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\
\>[12]{}\hsindent{34}{}\<[46]%
\>[46]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{x1}\mathbin{*}\Varid{x2},(\Varid{x1}\mathbin{*}\Varid{y2})\mathbin{+}(\Varid{y1}\mathbin{*}\Varid{x2})){}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{ad\char95 unop}\;(\Varid{op},(\Varid{x},\Varid{y}))\mid \Varid{op}\equiv \Conid{Negate}\mathrel{=}((\mathbin{-}\mathrm{1})\mathbin{*}\Varid{x},(\mathbin{-}\mathrm{1})\mathbin{*}\Varid{y}){}\<[E]%
\\
\>[12]{}\hsindent{21}{}\<[33]%
\>[33]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{\Conid{Prelude}.exp}\;(\Varid{x}),\Varid{y}\mathbin{*}\Varid{\Conid{Prelude}.exp}\;(\Varid{x})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
%
     \ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Varid{nil}}{\Varid{avg}\comp \Varid{cons}}\mathrel{=}\alt{\p1\comp \Varid{b}\comp \Varid{id}}{\p1\comp \Varid{q}\comp (\Varid{id}\times\conj{\Varid{avg}}{\Varid{aux}})}\\\alt{\length \comp \Varid{nil}}{\length \comp \Varid{cons}}\mathrel{=}\alt{\p2\comp \Varid{b}\comp \Varid{id}}{\p2\comp \Varid{q}\comp (\Varid{id}\times\conj{\Varid{avg}}{\Varid{aux}})}\end{lcbr}}
%
\just\equiv{ Lei 27 - Eq +, 2 vezes; Lei 1, Natural-id}
%
     \ensuremath{\begin{lcbr}\Varid{avg}\comp \Varid{nil}\mathrel{=}\p1\comp \Varid{b}\\\Varid{avg}\comp \Varid{cons}\mathrel{=}\p1\comp \Varid{q}\comp (\Varid{id}\times\conj{\Varid{avg}}{\Varid{aux}})\end{lcbr}\mid \begin{lcbr}\length \comp \Varid{nil}\mathrel{=}\p2\comp \Varid{b}\\\length \comp \Varid{cons}\mathrel{=}\p2\comp \Varid{q}\comp (\Varid{id}\times\conj{\Varid{avg}}{\Varid{aux}})\end{lcbr}}
\qed
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{aux}\;(\Varid{elem},(\Varid{media},\Varid{comprimento}))\mathrel{=}((\Varid{elem}\mathbin{+}\Varid{media}\mathbin{*}\Varid{comprimento})\mathbin{/}(\Varid{comprimento}\mathbin{+}\mathrm{1}),\Varid{comprimento}\mathbin{+}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{aux}\;((\Varid{md1},\Varid{comp1}),(\Varid{md2},\Varid{comp2}))\mathrel{=}((\Varid{md1}\mathbin{*}\Varid{comp1}\mathbin{+}\Varid{comp2}\mathbin{*}\Varid{md2})\mathbin{/}(\Varid{comp1}\mathbin{+}\Varid{comp2}),\Varid{comp1}\mathbin{+}\Varid{comp2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
