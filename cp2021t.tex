...
\start
%
	\ensuremath{\Varid{calcLine}\mathrel{=}\cata{\Varid{h}}}
%
\just\equiv{ Lei 45 - Universal-cata }
%
     \ensuremath{\Varid{calcLine}\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \Conid{F}\;\Varid{calcLine}}
%
\just\equiv{ Definição de in para listas ([nil,cons]) e Functor das listas: F f = id + id x f}
%
     \ensuremath{\Varid{calcLine}\comp \alt{\Varid{nil}}{\Varid{cons}}\mathrel{=}\Varid{h}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f})}
%
\just\equiv{ Lei 20 - Fusão-+; h = [h1,h2] }
%
     \ensuremath{\alt{\Varid{calcLine}\comp \Varid{nil}}{\Varid{calcLine}\comp \Varid{cons}}\mathrel{=}\alt{\Varid{h1}}{\Varid{h2}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f})}
%
\just\equiv{ Lei 22 - Absorção-+}
%
     \ensuremath{\alt{\Varid{calcLine}\comp \Varid{nil}}{\Varid{calcLine}\comp \Varid{cons}}\mathrel{=}\alt{\Varid{h1}\comp \Varid{id}}{\Varid{h2}\comp (\Varid{id}\times\Varid{calcLine})}}
%
\just\equiv{ Lei 27 - Eq-+}
%
     \ensuremath{\begin{lcbr}\Varid{calcLine}\comp \Varid{nil}\mathrel{=}\Varid{h1}\comp \Varid{id}\\\Varid{calcLine}\comp \Varid{cons}\mathrel{=}\Varid{h2}\comp (\Varid{id}\times\Varid{calcLine})\end{lcbr}}
%
\just\equiv{ Lei 1 - Natural-id; Lei 71 - Igualdade Extensional; Lei 72 - Def-comp}
%
     \ensuremath{\begin{lcbr}\Varid{calcLine}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{h1}\\\Varid{calcLine}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\Varid{h2}\;(\Varid{h},\Varid{calcLine}\;\Varid{t})\end{lcbr}}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h1}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h2}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
