...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{f},\Varid{h},\Varid{b},\Varid{c})\mathrel{=}(\Varid{c}\mathbin{*}\Varid{h},\Varid{b}\mathbin{/}\Varid{c},\mathrm{4}\mathbin{+}\Varid{b},\mathrm{1}\mathbin{+}\Varid{c}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{1},\mathrm{6},\mathrm{3}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\begin{eqnarray*}
\start
	\ensuremath{\Varid{avg\char95 aux}\mathrel{=}\cata{\conj{\Varid{b}}{\Varid{q}}}}
%
\just\equiv{ Definição de avg\textunderscore aux}
%
     \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\Varid{b}}{\Varid{q}}}}
%
...
%
     \ensuremath{\begin{lcbr}\Varid{avg}\comp \Varid{nil}\mathrel{=}\p1\comp \Varid{b}\\\Varid{avg}\comp \Varid{cons}\mathrel{=}\p1\comp \Varid{q}\times\conj{\Varid{avg}}{\length }\end{lcbr}\mid \begin{lcbr}\length \comp \Varid{nil}\mathrel{=}\p2\comp \Varid{b}\\\length \comp \Varid{cons}\mathrel{=}\p2\comp \Varid{q}\times\conj{\Varid{avg}}{\length }\end{lcbr}}
\qed
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
